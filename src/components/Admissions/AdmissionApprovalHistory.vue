...
<div>
    <b-card>
        <b-row align-v="center" slot="header">
            <b-col cols="8">
                <h3 class="mb-0">Search Approval History</h3>
            </b-col>
        </b-row>
         <b-row>
            <b-col lg="3">
    ...
    <card class="mt-3 mb-3">
        <b-row align-v="center" slot="header">
            <b-col cols="8">
                <h3 class="mb-0">Approval History
                </h3>
            </b-col>
        </b-row>
...
import AdmissionApprovalHistory from "./DefFile/AdmissionApprovalHistoryDef.js";
...
export default {
    ...
    data() {
        return {
            fields: AdmissionApprovalHistory,
        };
    },
}
</script>
