...
<div>
    <b-card>
        <b-row align-v="center" slot="header">
            <b-col cols="8">
                <h3 class="mb-0">Admissions History</h3>
            </b-col>
        </b-row>
        <b-row>
            <b-col lg="3">
      ...
      <card class="mt-3 mb-3">
        <b-row align-v="center" slot="header">
            <b-col cols="8">
                <h3 class="mb-0">Admissions History
                </h3>
            </b-col>
        </b-row>
            ...
            <b-col cols="12">
                <vuetable class="table-striped " ref="vuetable" api-url="https://vuetable.ratiw.net/api/users" :fields="fields" :sort-order="sortOrder" data-path="data" :per-page="5" pagination-path="" @vuetable:pagination-data="onPaginationData">
                    <div slot="custom-actions">
                        <b-button variant="warning" size="sm">View</b-button>
                    </div>
...
import AdmissionHistoryDef from "./DefFile/AdmissionHistoryDef.js";
